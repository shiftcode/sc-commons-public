...
describe('prepare-dist', () => {
  test('path rewrite', () => {
    ...
    const packageJson2 = {
      ...packageJson,
      exports: { '.': { types: './dist/index.d.ts', default: './dist/index.js', require: './dist/_cjs/index.js' } },
    }
    const fixedPackagesJson = fixPackageJsonPaths(packageJson, 'dist/', () => {})
    expect(fixedPackagesJson).toEqual({
      ...packageJson,
      main: './_cjs/index.js',
      module: './index.js',
      exports: { '.': './index.js' },
    ...
    expect(fixedPackagesJson2).toEqual({
      ...packageJson2,
      main: './_cjs/index.js',
      module: './index.js',
      exports: { '.': { types: './index.d.ts', default: './index.js', require: './_cjs/index.js' } },
    })
  })
